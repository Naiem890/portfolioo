(function ($) {
  ...
  */
        ...
        var swiper6 = new Swiper('.cs_slider_5', {
          ...
          pagination: {
            ...
            renderBullet: function (index, className) {
              return `<span class="${className}"><span class="cs_swiper_bullet_text cs_title_animation">${menu[index]}</span></span>`;
            },
          },
          direction: 'vertical',
          mousewheel: true,
  ...
  --------------------------------------------------------------*/
  // Title Animation
  let title = gsap.utils.toArray('.cs_title_animation');

  title.forEach(splitTextLine => {
    ...
    const titleSplitte = new SplitText(splitTextLine, {
      type: 'words, lines',
    });
    gsap.set(splitTextLine, { perspective: 400 });
    titleSplitte.split({ type: 'lines' });
    titleLine.from(titleSplitte.lines, {
      duration: 1,
      delay: 0.3,
      opacity: 0,
      rotationX: -80,
  ...
  //  Buttons Animation
  let button = gsap.utils.toArray('.cs_btn_animation');
  button.forEach(btn => {
    gsap.from(btn, {
      scrollTrigger: {
        trigger: btn,
  ...
  let heroTitleSplit = new SplitText(
    '.cs_hero.cs_style_1 .cs_hero_title, .cs_section_heading.cs_style_4 .cs_section_title',
    {
      type: 'chars',
    },
  );
  hero.from(heroTitleSplit.chars, {
    rotate: 20,
    ease: 'back.out',
    opacity: 0,
    duration: 1,
  ...
  var heroBtn = document.querySelector('.cs_hero.cs_style_1 .cs_hero_btn_wrap');
  ...
  // Classic Hero
  let HomeClassic = gsap.timeline();
  let classicHeroTitle = document.querySelector(
    '.cs_hero.cs_style_2 .cs_hero_title',
  );
  let classicHeroTitleSplit = new SplitText(classicHeroTitle, {
    type: 'chars',
  });

  HomeClassic.from(classicHeroTitleSplit.chars, {
    duration: 1.5,
    x: 100,
    autoAlpha: 0,
    stagger: 0.1,
